...
export default function BandHero({ band, heroImg, heroParallaxRef, allowHeroVideo }) {
  ...
  return (
    <section className="bh" style={{ '--band': band.color }}>
      <style>{`
        .bh{min-height:100svh;position:relative;overflow:hidden;display:grid;align-items:end;padding:clamp(112px,12vw,180px) 0 clamp(40px,6vw,82px);background:#040404;color:#fff;isolation:isolate;border-bottom:1px solid rgba(255,255,255,.14)}.bh:before{content:'';position:absolute;inset:0;z-index:1;pointer-events:none;background:linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:25vw 100%;opacity:.28}.bh:after{content:'';position:absolute;inset:0;z-index:2;pointer-events:none;background:linear-gradient(90deg,rgba(0,0,0,.18),rgba(0,0,0,.05) 34%,rgba(0,0,0,.78)),linear-gradient(180deg,rgba(0,0,0,.08) 0%,rgba(0,0,0,.22) 42%,rgba(0,0,0,.92) 86%,#080808 100%)}
        .bh-media{position:absolute;inset:0;z-index:0;will-change:transform}.bh-media img,.bh-media video{filter:saturate(.82) contrast(1.14)}.bh-grid{width:min(1500px,calc(100vw - clamp(28px,7vw,108px)));margin:0 auto;position:relative;z-index:3;display:grid;grid-template-columns:minmax(0,1.08fr) minmax(280px,.92fr);gap:clamp(24px,5vw,78px);align-items:end}.bh-kicker{display:flex;align-items:center;gap:10px;font-family:var(--ff-label);font-size:11px;font-weight:900;letter-spacing:.22em;text-transform:uppercase;color:var(--band);margin-bottom:16px}.bh-kicker:before{content:'';width:30px;height:2px;background:var(--band)}.bh h1{font-family:var(--ff-display);font-size:clamp(82px,15vw,222px);line-height:.72;letter-spacing:-.01em;text-transform:uppercase;text-shadow:0 3px 38px rgba(0,0,0,.72);max-width:1060px}.bh-tags{display:flex;flex-wrap:wrap;margin-top:24px;border:1px solid rgba(255,255,255,.15);width:max-content;max-width:100%}.bh-tags span{border-right:1px solid rgba(255,255,255,.15);color:rgba(255,255,255,.72);background:rgba(0,0,0,.48);padding:10px 12px;font-family:var(--ff-label);font-size:10px;font-weight:900;letter-spacing:.16em;text-transform:uppercase}.bh-tags span:last-child{border-right:0}.bh-actions{display:flex;flex-wrap:wrap;gap:10px;margin-top:26px}.bh-btn{display:inline-flex;align-items:center;justify-content:center;min-height:50px;padding:0 18px;border:1px solid rgba(255,255,255,.22);background:#060606;color:#fff;text-decoration:none;font-family:var(--ff-label);font-size:11px;font-weight:900;letter-spacing:.16em;text-transform:uppercase;transition:transform .18s ease,border-color .18s ease,color .18s ease,background .18s ease}.bh-btn:hover{transform:translateY(-2px);border-color:var(--band);color:var(--band)}.bh-btn-primary{background:var(--band);border-color:var(--band);color:#060606}.bh-btn-primary:hover{color:#060606}.bh-panel{border:1px solid rgba(255,255,255,.16);background:rgba(0,0,0,.52)}.bh-panel-label{font-family:var(--ff-label);font-size:10px;font-weight:900;letter-spacing:.2em;text-transform:uppercase;color:var(--band);padding:15px 16px;border-bottom:1px solid rgba(255,255,255,.14)}.bh-stats{display:grid;grid-template-columns:repeat(2,1fr);background:rgba(255,255,255,.14);gap:1px}.bh-stat{background:#060606;padding:16px}.bh-stat strong{display:block;font-family:var(--ff-display);font-size:34px;line-height:.82;text-transform:uppercase}.bh-stat span{display:block;margin-top:8px;color:rgba(255,255,255,.45);font-size:10px;letter-spacing:.14em;text-transform:uppercase}.bh-social{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:rgba(255,255,255,.14);border-top:1px solid rgba(255,255,255,.14)}.bh-social a{display:inline-flex;align-items:center;gap:8px;padding:13px 15px;color:rgba(255,255,255,.62);text-decoration:none;font-family:var(--ff-label);font-size:10px;font-weight:900;letter-spacing:.14em;text-transform:uppercase;background:#060606}.bh-social a:hover{color:#060606;background:var(--band)}@media(max-width:980px){.bh-grid{grid-template-columns:1fr}.bh-panel{max-width:760px}.bh-stats{grid-template-columns:repeat(2,1fr)}}@media(max-width:620px){.bh{min-height:auto;padding:108px 0 70px}.bh:before{background-size:50vw 100%;opacity:.2}.bh-grid{width:min(100% - 26px,1500px)}.bh h1{font-size:clamp(72px,24vw,136px)}.bh-tags{width:100%}.bh-tags span{flex:1 1 auto}.bh-actions{display:grid;grid-template-columns:1fr}.bh-btn{width:100%}.bh-stats,.bh-social{grid-template-columns:1fr}}
      `}</style>
