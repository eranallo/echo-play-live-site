  ...
  return (
    <main className="sw-shell">
      ...
      <div className="sw-wrap">
        ...
        <nav className="sw-nav"><a href="#readiness">Readiness</a><a href="#edit">Edit</a><a href="#timeline">Timeline</a><a href="#tasks">Tasks</a><a href="#specialists">Specialists</a><a href="#promo">Promo</a></nav>
