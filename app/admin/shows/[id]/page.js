...
import { getCachedAdminShowDetail } from '@/lib/admin/cachedAirtable'
...
export default async function AdminShowDetailPage({ params }) {
  ...
  const detail = showId ? await getCachedAdminShowDetail(showId) : { ok: false, show: null, error: 'No show ID was provided in the admin route.' }
