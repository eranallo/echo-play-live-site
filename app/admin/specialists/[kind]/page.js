...
export default async function SpecialistGuidePage({ params }) {
  ...
  if (!guide) {
    return (
      <main className="sg-shell"><div className="sg-wrap"><a className="sg-back" href="/admin/specialists">← Specialists</a><section className="sg-panel"><h1>Specialist not found.</h1><p>Return to the Specialist Hub and choose one of the active lanes.</p></section></div></main>
    )
  }
