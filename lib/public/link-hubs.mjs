...
export const linkHubs = [
  {
    ...
    links: [
      ...
      ['Request a song', 'Help us choose what to learn next', '/requests'],
  ...
  ...bandKits.map((kit) => ({
    ...
    links: [
      ...
      ['Request a song', 'Help us choose what to learn next', `/requests?band=${kit.slug}`],
      ['The song catalog', 'Album artwork, songs & Spotify links', `/bands/${kit.slug}#music`],
