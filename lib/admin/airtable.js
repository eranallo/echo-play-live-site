...
function normalizeTaskRecord(record) {
  ...
  return {
    id: record.id,
    title: fields['Task Name'] || fields.Name || fields.Title || 'Untitled Task',
    status: fields.Status || 'Todo',
    priority: fields.Priority || 'Normal',
    dueDate: fields['Due Date'] || fields.Due || null,
    dueLabel: formatDate(fields['Due Date'] || fields.Due),
    owner: formatValue(fields.Owner || fields.Assignee),
    source: fields.Source || fields['Created By'] || 'Manual',
    relatedShow: formatValue(fields.Show || fields['Related Show']),
    notes: fields.Notes || fields.Description || '',
    completedAt: formatDateTime(fields['Completed At']),
  }
}
