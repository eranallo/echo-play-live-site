...
// Phase 20.6 hotfix: bumped v3→v4 because v3 picked up null entries during
// the limit=20 era (Spotify rejects ≥20 even though docs say 50 is max).
// With the limit=10 fix above, v4 will populate with real album data.
// retry-on-null wrapper below remains as belt-and-suspenders.
const _cachedDiscography = unstable_cache(
  async (artistId) => _getArtistDiscographyOnce(artistId),
  ['spotify-discography-v4'],
