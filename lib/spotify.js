...
// Phase 20.7 hotfix: bumped v4→v5 because v4 was empty arrays from the
// batch-albums failure (Spotify rejected the batch endpoint same as the
// artist-albums one). With per-album fetches now, v5 will populate with
// real track data.
const _cachedDiscography = unstable_cache(
  async (artistId) => _getArtistDiscographyOnce(artistId),
  ['spotify-discography-v5'],
