...
function normalizeMember(rec) {
  ...
  // Photo: take first attachment from "Website Photo" field if present.
  ...
  // curated field. Falls back to no photo (initials placeholder in UI) until
  // Evan creates the field and adds attachments.
  const photoArr = Array.isArray(f['Website Photo']) ? f['Website Photo'] : []
