...
function normalizeMember(rec) {
  ...
  // Phase 23: expose ALL Website Photo attachments as `photos[]` so the
  // musician page can render a gallery. `photo` remains the primary (first)
  // attachment for backwards compatibility with existing callers (OG image,
  // band lineup card, etc.).
